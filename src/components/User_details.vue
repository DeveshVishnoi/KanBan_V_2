...
export default {
  ...
  methods: {
    ...
    addlist() {
      fetch("https://kanban-v-2-mb2w.onrender.com/api/list/" + this.user_id, {
        method: "POST",
        headers: {
    ...
    delete_list(id) {
      fetch(`https://kanban-v-2-mb2w.onrender.com/api/${this.user_id}/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "x-access-token": localStorage.getItem("token"),
    ...
    delete_card(id, idd) {
      ...
      fetch(`https://kanban-v-2-mb2w.onrender.com/api/${this.user_id}/${idd}/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "x-access-token": localStorage.getItem("token"),
    ...
    export_card(l) {
      ...
      fetch("https://kanban-v-2-mb2w.onrender.com/api/export/" + this.user_id + "/"+l, {
        method: "GET",
        headers: { "x-access-token": localStorage.getItem("token") },
      })
        .then((res) => {
